        ...
        <div className="w-full max-w-3xl mx-auto px-6 py-8">
          ...
          <div className="w-full mb-8">
            ...
            {goalActions.length === 0 && !isInputMode ? (
              <div className="flex flex-col items-center justify-center py-12 px-6 border-2 border-dashed border-neutral-200 dark:border-neutral-800 rounded-lg">
                <div className="text-center space-y-4 w-full max-w-md">
                  ...
                  <div>
                    ...
                    <Button
                      ...
                      className="w-full py-3 px-4 bg-blue-500 hover:bg-blue-600 dark:bg-blue-600 dark:hover:bg-blue-700 text-white font-medium flex items-center justify-center gap-2"
                    >
                      <svg
                        className="w-5 h-5"
                        fill="none"
                    ...
                    <p className="text-xs text-neutral-500 dark:text-neutral-400 mt-3">
                      Or press <kbd className="px-2 py-1 bg-neutral-100 dark:bg-neutral-800 rounded font-mono border border-neutral-200 dark:border-neutral-700">+</kbd> key
                    </p>
                  </div>
                </div>
              </div>
